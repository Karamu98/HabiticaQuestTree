...
function autoquesterFunc(body) {
    return __awaiter(this, void 0, void 0, function* () {
        dotenv_1.default.config();
        try {
            const allData = WebhookUpdateData_1.WebhookConvert.ToData(body);
                            ...
                            if (data != null) {
                                ...
                                tagsMap.forEach((value, key) => {
                                    if (value.Total > 0) {
                                        ...
                                        value.ListeningHabits.forEach((habitTask) => __awaiter(this, void 0, void 0, function* () {
